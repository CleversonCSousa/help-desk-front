import { PenLineIcon, Trash } from "lucide-react";
                ...
                >
                  ...
                  <td className="w-[88px] px-2 py-1 align-middle md:px-3 md:py-4">
                    <div className="flex shrink-0 items-center justify-end gap-1.5">
                      ...
                      <button className="text-feedback-danger flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-md bg-gray-500">
                        <Trash size={16} />
                      </button>
                    </div>
                  </td>
